...
ALTER TABLE rbac_account_authority
    ADD CONSTRAINT a7 FOREIGN KEY (rbac_account_id) REFERENCES rbac_account (id);
ALTER TABLE rbac_account_authority
    ADD CONSTRAINT a8 FOREIGN KEY (rbac_permission_id) REFERENCES rbac_permission (id);
ALTER TABLE rbac_account_authority
    ADD CONSTRAINT a25 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_account_data_power
    ADD CONSTRAINT a10 FOREIGN KEY (rbac_dept_id) REFERENCES rbac_dept (id);
ALTER TABLE rbac_account_data_power
    ADD CONSTRAINT a11 FOREIGN KEY (rbac_account_id) REFERENCES rbac_account (id);
ALTER TABLE rbac_account_data_power
    ADD CONSTRAINT a24 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_account_manage
    ADD CONSTRAINT a20 FOREIGN KEY (rbac_account_id) REFERENCES rbac_account (id);
ALTER TABLE rbac_account_manage
    ADD CONSTRAINT a21 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_account_manage
    ADD CONSTRAINT a22 FOREIGN KEY (rbac_dept_id) REFERENCES rbac_dept (id);
ALTER TABLE rbac_account_role_rel
    ADD CONSTRAINT a3 FOREIGN KEY (rbac_role_id) REFERENCES rbac_role (id);
ALTER TABLE rbac_account_role_rel
    ADD CONSTRAINT a4 FOREIGN KEY (rbac_account_id) REFERENCES rbac_account (id);
ALTER TABLE rbac_account_role_rel
    ADD CONSTRAINT a26 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_dept
    ADD CONSTRAINT a9 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_role
    ADD CONSTRAINT a2 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
...
ALTER TABLE rbac_role_data_power
    ADD CONSTRAINT a23 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_tenant_authority
    ADD CONSTRAINT a18 FOREIGN KEY (rbac_tenant_id) REFERENCES rbac_tenant (id);
ALTER TABLE rbac_tenant_authority
