...
//
//             List<RbacRoleDto> roles = customUserDetailsDao.selectRoleByUserId(userId);
...
//             List<RbacPermissionDto> btnPerms = permissions.stream()
//                                                    // 过滤页面权限
...
//
//             for (RbacPermissionDto btnPerm : btnPerms) {
