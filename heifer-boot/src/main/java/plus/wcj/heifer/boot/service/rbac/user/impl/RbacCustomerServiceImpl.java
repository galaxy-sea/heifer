...
import plus.wcj.heifer.boot.dao.rbac.user.RbacCustomerDao;
 ...
 */
@Service
public class RbacCustomerServiceImpl extends ServiceImpl<RbacCustomerDao, RbacCustomer> implements RbacCustomerService {
