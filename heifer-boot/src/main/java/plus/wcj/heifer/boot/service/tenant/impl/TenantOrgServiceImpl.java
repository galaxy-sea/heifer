...
import plus.wcj.heifer.boot.mapper.tenant.TenantOrgDao;
 ...
 */
@Service
public class TenantOrgServiceImpl extends ServiceImpl<TenantOrgDao, TenantOrgDo> implements TenantOrgService {
