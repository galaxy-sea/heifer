...
public class TenantOrgClientRelController {
    ...
    public Page<TenantOrgClientRelDo> page(Page<TenantOrgClientRelDo> page, TenantOrgClientRelDo tenantOrgClientRelDo) {
        return tenantOrgClientRelService.page(page, tenantOrgClientRelDo);
    }

    @PostMapping
    @ResultResponseBody
    public boolean save(@RequestBody @Validated(value = PostValid.class) TenantOrgClientRelDo tenantOrgClientRelDo) {
        return tenantOrgClientRelService.save(tenantOrgClientRelDo);
    }

    @PutMapping
    @ResultResponseBody
    public boolean updateById(@RequestBody @Validated(value = PutValid.class) TenantOrgClientRelDo tenantOrgClientRelDo) {
