...
import plus.wcj.heifer.boot.dao.rbac.user.RbacUserDataPowerDao;
 ...
 */
@Service
public class RbacUserDataPowerServiceImpl extends ServiceImpl<RbacUserDataPowerDao, RbacUserDataPower> implements RbacUserDataPowerService {
