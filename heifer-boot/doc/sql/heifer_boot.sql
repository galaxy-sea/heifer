...
ALTER TABLE rbac_admin
    ADD CONSTRAINT a25 FOREIGN KEY (rbac_user_id) REFERENCES rbac_user (id);
ALTER TABLE rbac_admin
    ADD CONSTRAINT `26` FOREIGN KEY (rbac_dept_id) REFERENCES rbac_dept (id);
ALTER TABLE rbac_customer
    ADD CONSTRAINT a24 FOREIGN KEY (rbac_user_id) REFERENCES rbac_user (id);
