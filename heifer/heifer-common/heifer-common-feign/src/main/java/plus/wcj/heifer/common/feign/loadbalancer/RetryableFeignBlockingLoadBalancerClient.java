...
/**
 * A {@link feign.Client} implementation that provides Spring Retry support for requests
...
public class RetryableFeignBlockingLoadBalancerClient implements Client {
	...
	public RetryableFeignBlockingLoadBalancerClient(Client delegate, LoadBalancerClient loadBalancerClient, LoadBalancedRetryFactory loadBalancedRetryFactory, LoadBalancerClientFactory loadBalancerClientFactory, List<LoadBalancerFeignRequestTransformer> transformers) {
