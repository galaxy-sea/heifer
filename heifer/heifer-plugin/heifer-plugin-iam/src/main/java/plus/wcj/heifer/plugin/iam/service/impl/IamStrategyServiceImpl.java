...
import plus.wcj.heifer.plugin.iam.dao.IamStrategyDao;
 ...
 */
@Service
public class IamStrategyServiceImpl extends ServiceImpl<IamStrategyDao, IamStrategy, Long> implements IamStrategyService {
    // 自动生成外键查询  请勿修改
    // 自动生成外键查询  请勿修改
